...
def image2fen(chessboard):
    ...
    rook_template = cv2.imread("rook.png")
    knight_template = cv2.imread("knight.png")
    bishop_template = cv2.imread("bishop.png")
    queen_template = cv2.imread("queen.png")
    king_template = cv2.imread("king.png")
